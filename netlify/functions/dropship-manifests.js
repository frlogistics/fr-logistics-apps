...
async function actionList(url) {
  ...
  const qs = [
    "select=manifest_id,outbound_carrier,status,package_count,created_at,sealed_at,sealed_by,released_at,released_by,pdf_url,csv_url,email_sent_at,email_sent_to,public_token,last_viewed_at,view_count",
